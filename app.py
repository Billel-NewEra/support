...
def submit():
    ...
    if email and EMAIL_REGEX.match(email):
        try:
            ...
            msg_client.reply_to = None  # désactiver reply-to
              ...
              <body style="font-family: Arial, sans-serif; color: #333; background-color:#f9f9f9; padding:20px;">
                <div style="max-width:600px; margin:0 auto; background:#ffffff; padding:20px; border-radius:8px; box-shadow:0 0 10px rgba(0,0,0,0.1);">
                  ...
                  <p style="margin-top:20px; text-align:center;">
                    📎 <strong>Consulter votre fiche :</strong><br>
                    <a href="{lien_impression}" target="_blank" style="color:#1c3faa;">
                      Cliquez ici
                    </a>
                  </p>

                  <p style="margin-top:30px; text-align:center; font-size:0.9rem; color:#666;">
            ...
            print("❌ Erreur envoi email client:", e)
    else:
        print("ℹ️ Aucun email client à envoyer.")


    # ==================================================
    # 2) EMAIL INTERNE ADMIN (toujours envoyé)
    # ==================================================
    try:
        msg_admin = Message(
        ...
        msg_admin.reply_to = None  # sécurité
        ...
        print("❌ Erreur envoi email interne:", e)
